...
class analyzer:
    ...
    def __init__(self, *methods, min_error=0.001, max_error=0.01, error_step=0.001):
        '''
    ...
    def graph(self):
        ...
        sx = [i * self.error_step for i in range(1, int((self.max_error - self.min_error) / self.error_step) + 1)]
